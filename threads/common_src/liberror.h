...
public:
    ...
    /*
     * Obtención del error code obtenido.
     *
     * (en este trabajo práctico, usado para reconocer cuando falla el método accept()
     * por haberse cerrado el socket del servidor.)
     */
